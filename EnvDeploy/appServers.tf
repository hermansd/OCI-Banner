...
resource "oci_core_instance" "appServer" {
  ...
  fault_domain        = var.app_multiple_fds ? ((contains(range(1,var.app_host_count , 2), count.index)) ? var.app_target_fd2 : var.app_target_fd1) : element(local.fault_domain,count.index)
